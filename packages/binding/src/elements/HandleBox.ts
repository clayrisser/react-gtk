...
export default class HandleBox extends Element {
  static propTypes = {
    childDetached: PropTypes.bool,
    handlePosition: PropTypes.object,
    shadowType: PropTypes.object,
    snapEdge: PropTypes.object,
    snapEdgeSet: PropTypes.bool,
  ...
  constructor(props: object = {}) {
    super(new Gtk.HandleBox(), props, { isContainer: true });
  }
