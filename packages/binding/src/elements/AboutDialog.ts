...
export default class AboutDialog extends Element {
  static propTypes = {
    artists: PropTypes.array,
    authors: PropTypes.array,
    comments: PropTypes.string,
    copyright: PropTypes.string,
    documenters: PropTypes.array,
    license: PropTypes.string,
    licenseType: PropTypes.object,
    logo: PropTypes.object,
    logoIconName: PropTypes.string,
    programName: PropTypes.string,
    translatorCredits: PropTypes.string,
    version: PropTypes.string,
    website: PropTypes.string,
    websiteLabel: PropTypes.string,
    wrapLicense: PropTypes.bool,
  ...
  constructor(props: object = {}) {
    super(new Gtk.AboutDialog(), props, { isContainer: true });
  }

  addCreditSection(sectionName: string, people: string[]): null {
    return this.node.addCreditSection(sectionName, people);
  }
