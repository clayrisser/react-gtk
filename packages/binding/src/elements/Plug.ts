...
export default class Plug extends Element {
  static propTypes = {
    embedded: PropTypes.bool,
    socketWindow: PropTypes.object,
  ...
  constructor(props: object = {}) {
    super(new Gtk.Plug(), props, { isContainer: true });
  }

  construct(socketId: object): null {
    return this.node.construct(socketId);
  }

  constructForDisplay(display: object, socketId: object): null {
    return this.node.constructForDisplay(display, socketId);
  }
