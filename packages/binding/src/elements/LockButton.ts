...
export default class LockButton extends Element {
  static propTypes = {
    permission: PropTypes.object,
    textLock: PropTypes.string,
    textUnlock: PropTypes.string,
    tooltipLock: PropTypes.string,
    tooltipNotAuthorized: PropTypes.string,
    tooltipUnlock: PropTypes.string,
  ...
  constructor(props: object = {}) {
    super(new Gtk.LockButton(), props, { isContainer: true });
  }
