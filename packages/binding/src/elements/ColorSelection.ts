...
export default class ColorSelection extends Element {
  static propTypes = {
    currentAlpha: PropTypes.number,
    currentColor: PropTypes.object,
    currentRgba: PropTypes.object,
    hasOpacityControl: PropTypes.bool,
  ...
  constructor(props: object = {}) {
    super(new Gtk.ColorSelection(), props, { isContainer: true });
  }
