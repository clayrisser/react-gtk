...
export default class Assistant extends Element {
  static propTypes = {
  ...
  constructor(props: object = {}) {
    super(new Gtk.Assistant(), props, { isContainer: true });
  }

  addActionWidget(child: object): null {
    return this.node.addActionWidget(child);
  }

  appendPage(page: object): number {
    return this.node.appendPage(page);
  }

  commit(): null {
    return this.node.commit();
  }

  insertPage(page: object, position: number): number {
    return this.node.insertPage(page, position);
  }
  ...
  prependPage(page: object): number {
    return this.node.prependPage(page);
  }

  previousPage(): null {
    return this.node.previousPage();
  }

  removeActionWidget(child: object): null {
    return this.node.removeActionWidget(child);
  }
  ...
  updateButtonsState(): null {
    return this.node.updateButtonsState();
  }
