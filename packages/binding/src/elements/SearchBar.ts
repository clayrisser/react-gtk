...
export default class SearchBar extends Element {
  static propTypes = {
    searchModeEnabled: PropTypes.bool,
  ...
  constructor(props: object = {}) {
    super(new Gtk.SearchBar(), props, { isContainer: true });
  }

  connectEntry(entry: object): null {
    return this.node.connectEntry(entry);
  }

  handleEvent(event: object): boolean {
    return this.node.handleEvent(event);
  }
