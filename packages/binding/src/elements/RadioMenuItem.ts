...
export default class RadioMenuItem extends Element {
  static propTypes = {
  ...
  constructor(props: object = {}) {
    super(new Gtk.RadioMenuItem(), props, { isContainer: true });
  }

  joinGroup(groupSource: object): null {
    return this.node.joinGroup(groupSource);
  }
