...
export default class Overlay extends Element {
  ...
  constructor(props: object = {}) {
    super(new Gtk.Overlay(), props, { isContainer: true });
  }

  addOverlay(widget: object): null {
    return this.node.addOverlay(widget);
  }

  reorderOverlay(child: object, position: number): null {
    return this.node.reorderOverlay(child, position);
  }
