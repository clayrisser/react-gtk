...
export default class MessageDialog extends Element {
  static propTypes = {
    ...
    secondaryUseMarkup: PropTypes.bool,
  ...
  constructor(props: object = {}) {
    super(new Gtk.MessageDialog(), props, { isContainer: true });
  }

  formatSecondaryMarkup(messageFormat: string, ___: object): null {
    return this.node.formatSecondaryMarkup(messageFormat, ___);
  }

  formatSecondaryText(messageFormat: string, ___: object): null {
    return this.node.formatSecondaryText(messageFormat, ___);
  }
