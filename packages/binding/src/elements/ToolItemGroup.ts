...
export default class ToolItemGroup extends Element {
  static propTypes = {
    collapsed: PropTypes.bool,
    ellipsize: PropTypes.object,
    headerRelief: PropTypes.object,
  ...
  constructor(props: object = {}) {
    super(new Gtk.ToolItemGroup(), props, { isContainer: true });
  }

  insert(item: object, position: number): null {
    return this.node.insert(item, position);
  }
